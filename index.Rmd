...
* **Office hours (online)**: Thursday 4:30-6:30PM ([link](https://urban-analytics-2024.youcanbook.me/))
...
```{r, echo=FALSE}
topic_col <- c(
  "Introduction: Class structure, format & expectations [(Slide)](https://ujhwang.github.io/urban-analytics-2024/Lecture_Slides/Lecture-1/LectureONE.html), <br> 
  ...
  "<b><font color=pink> Student Presentation of Final Project Data, Methods, & Preliminary Results (Nov 4)</font></b> <br> Social Media Analysis ([Slide](https://raw.githubusercontent.com/ujhwang/urban-analytics-2024/main/uc.jpg)) <br>",# 12
