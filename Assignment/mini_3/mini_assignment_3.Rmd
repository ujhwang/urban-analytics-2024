...
you will need hospital POI data from Yelp (provided via [this link]()) and Census ACS data. You will carefully choose variables in the Census ACS for the analysis, perform exploratory data analysis using these two datasets, and share your insights, including answering this question: ***is the spatial distribution of hospitals in the area equitable?***

**To complete this assignment, follow the directions below:**

1. Import the Yelp data ([link]()) using `st_read` and check if the data is tidy.
2. Explore variables in the Census ACS 5-year estimate, select variables that you think are suitable for equity analysis, and justify your choice.
  * To explore the variables, use either NHGIS website or `tidycensus::load_variables`
