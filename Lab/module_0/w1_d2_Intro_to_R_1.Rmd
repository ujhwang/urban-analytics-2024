...
* Why use it?
    ...
    * **Popularity**: The most-used developer tool in [Stack Overflow 2024 survey](https://survey.stackoverflow.co/2024/technology#1-other-tools).
]
...
```{r}
# Read data
my_df <- read.csv("https://raw.githubusercontent.com/ujhwang/urban-analytics-2024/main/Lab/module_0/testdata.csv")
my_df %>% head() %>% print()
...
* CSV: .tiny[https://raw.githubusercontent.com/ujhwang/urban-analytics-2024/main/Lab/module_0/testdata.csv]

* GEOJSON: .tiny[https://raw.githubusercontent.com/ujhwang/urban-analytics-2024/main/Lab/module_0/testdata.geojson]

* JSON: .tiny[https://raw.githubusercontent.com/ujhwang/urban-analytics-2024/main/Lab/module_0/testdata.json]
...
```{r include=F}
shp <- sf::st_read("https://raw.githubusercontent.com/ujhwang/urban-analytics-2024/main/Lab/module_0/testdata.geojson")
```


```{r message=FALSE, eval=F}
shp <- sf::st_read("https://raw.githubusercontent.com/ujhwang/urban-analytics-2024/main/Lab/module_0/testdata.geojson") 
js <- jsonlite::fromJSON("https://raw.githubusercontent.com/ujhwang/urban-analytics-2024/main/Lab/module_0/testdata.json", flatten = TRUE)
```
